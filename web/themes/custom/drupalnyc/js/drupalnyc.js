// Best practice Drupal uses behaviours. These aren't that difficult once you
// get the hang of it. Source -  https://www.drupal.org/node/2269515
// --------------------------------- Example behaviour
// --------------------------------- Drupal.behaviors.myBehavior = { attach:
// function (context, settings) { // Using once() to apply the
// myCustomBehaviour effect when you want to do just run one function.
// $('input.myCustomBehavior',
// context).once('myCustomBehavior').addClass('processed');  // Using once()
// with more complexity. $('input.myCustom',
// context).once('mySecondBehavior').each(function () { if ($(this).visible())
// { $(this).css('background', 'green'); } else { $(this).css('background', 'yellow').show(); } }); } };  }(jQuery));
